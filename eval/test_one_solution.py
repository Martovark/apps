...
def print_results(results: Dict, args:argparse.Namespace=None):
    ...
    print(f"Strict Accuracy (all test cases passed / total problems) = {strict_accuracy}")
...
def main(args):
    ...
    if args.print_results:
        ...
        elif os.path.exists(os.path.join(args.save, f"{args.start}-{args.end}_results.json")):
            results_loc = os.path.join(args.save, f"{args.start}-{args.end}_results.json")
